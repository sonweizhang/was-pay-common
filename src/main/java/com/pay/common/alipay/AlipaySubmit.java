...
import com.pay.common.httpClient.HttpProtocolHandler;
import com.pay.common.httpClient.HttpRequest;
import com.pay.common.httpClient.HttpResponse;
import com.pay.common.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @throws Exception
     */
    public static String sendPostInfo(Map<String, String> sParaTemp)throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
